...
import (
	...
	"github.com/authorizedmi/got/internal/got"
...
func TestGot(t *testing.T) {
	...
	args = "-t got -i -o github.com/authorizedmi/got/internal/testdata/template -I github.com/authorizedmi/got/internal/testdata/src/inc2:github.com/authorizedmi/got/internal/testdata/src/inc:github.com/authorizedmi/got/internal/testdata/src/inc/testInclude4.inc -d github.com/authorizedmi/got/internal/testdata/src"
...
func TestRecursiveGot(t *testing.T) {
	...
	err := got.Run("",
		...
		false,
		"",
		"github.com/authorizedmi/got/internal/testdata/src/recurse",
		nil,
		true,
		true,
		false)
